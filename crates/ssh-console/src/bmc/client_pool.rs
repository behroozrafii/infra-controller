    ...
    fn new(meter: &Meter, members: Arc<RwLock<HashMap<MachineId, ClientHandle>>>) -> Self {
        Self {
            ...
            total_machines: meter
                ...
                .with_description("Number of host BMCs the SSH Console service has attempted connecting to").build(),
            _failed_machines: meter
                .u64_observable_gauge("ssh_console_failed_machines")
                .with_description("Number of host BMCs the SSH Console service has encountered multiple errors with")
                .with_callback({
