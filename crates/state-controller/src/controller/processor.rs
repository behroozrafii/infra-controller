...
impl ProcessorMetricsEmitter {
    pub(super) fn new(object_type: &str, meter: &Meter) -> Self {
        ...
        let dispatched_tasks_counter = meter
            ...
            .with_description(format!(
                "Number of object handling tasks that have been dequeued and dispatched for processing for objects of type {object_type}"
            ))
            .build();
        ...
        let completed_tasks_counter = meter
            ...
            .with_description(format!(
                "Number of object handling tasks that have been completed for objects of type {object_type}"
            ))
            .build();
        ...
        let requeued_tasks_counter = meter
            ...
            .with_description(format!(
                "Number of object handling tasks that have been requeued for objects of type {object_type}"
            ))
            .build();
