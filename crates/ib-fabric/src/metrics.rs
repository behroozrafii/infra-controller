    ...
    pub fn new(meter: Meter, shared_metrics: SharedMetricsHolder<IbFabricMonitorMetrics>) -> Self {
...

        {
            ...
            meter
                ...
                .with_description("Number of InfiniBand fabrics that are monitored")
        ...
        let ufm_changes_applied = meter
            ...
            .with_description("Number of changes that have been performed at UFM")
            .build();

        {
            ...
            meter
                ...
                .with_description(
                    "Number of Machines where the number of total and active ports matches the values in attributes",
                )
                .with_callback(move |o| {
                    metrics.if_available(|metrics, attrs| {
...

        {
            ...
            meter
                ...
                .with_description(
                    "Number of machines where at least one port is assigned to a pkey value that is not associated with any partition ID",
                )
                .with_callback(move |o| {
                    metrics.if_available(|metrics, attrs| {
...

        {
            ...
            meter
                ...
                .with_description("Number of InfiniBand fabrics that are not configured securely")
                .with_callback(move |o| {
                    metrics.if_available(|metrics, attrs| {
                        for (fabric, metrics) in metrics.fabrics.iter() {
                            o.observe(
...

        {
            ...
            meter
                ...
                .with_description(
                    "Number of InfiniBand fabrics that are allowed to use insecure configuration",
                )
                .with_callback(move |o| {
                    metrics.if_available(|metrics, attrs| {
                        for (fabric, metrics) in metrics.fabrics.iter() {
...

        {
            ...
            meter
                ...
                .with_description(
                    "Number of partitions registered at UFM in total (incl non Forge partitions)",
                )
                .with_callback(move |o| {
                    metrics.if_available(|metrics, attrs| {
                        for (fabric, metrics) in metrics.fabrics.iter() {
...

        {
            ...
            meter
                ...
                .with_description("Number of ports reported by UFM (incl non Forge managed ports)")
                .with_callback(move |o| {
                    metrics.if_available(|metrics, attrs| {
                        for (fabric, metrics) in metrics.fabrics.iter() {
